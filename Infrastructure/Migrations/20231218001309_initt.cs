    ...
    public partial class initt : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", maxLength: 32, nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 32, nullable: false),
                    CostPrice = table.Column<decimal>(type: "decimal(18,2)", maxLength: 20, nullable: true),
                    Quantity = table.Column<int>(type: "int", maxLength: 10, nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 32, nullable: true),
